...
function InitMain_ReadyTime(wnd)
	...
	ReadyStateFont = wnd:AddFontEx("请", 18, 0, 492, 18, 200, 20, 0xffffff)
	mode_yhjj = readyBK:AddFontEx( "永恒竞技场", 18, 0, 200, 13, 300, 20, 0xffffff)
...
function SetCurTitleState_teadytime( cState)
	if cState==1 then
		ReadyStateFont:SetFontText("请 选择英雄", 0xffffff)
	else
		ReadyStateFont:SetFontText("请 确认出击", 0xffffff)
	end
end
