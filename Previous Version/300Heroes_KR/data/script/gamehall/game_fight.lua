...
local MonsterName = {"归磅家券何","全捻颇家券何","没捻颇家券何","没救归锋家券何","傍吝锋坷矫府胶家券何","凉俺家券何"}
...
function InitMainGame_Fight(wnd)
	...
	pNewClassButton_YHJJ:AddFont("脚涝荐访", 15, 8, 0, 0, 179, 56, 0xffffff)
	...
	pNewClassButton_YHZC:AddFont("脚涝荐访", 15, 8, 0, 0, 179, 56, 0xffffff)
	pDeathButton_YZDEL = flag_YHZC:AddButton(path.."button1_hall.png", path.."button2_hall.png", path.."button3_hall.png", 444, 666,  179, 56)
	pDeathButton_YZDEL:AddFont("檬岿傈厘", 15, 8, 0, 0, 179, 56, 0xffffff)
	pDeathButton_YZDEL:AddFont("19:00 - 21:00 俺规", 15, 8, 0, 20, 179, 15, 0xff0000)
	...
	EquipDeploy:AddFont("厘厚厘馒",20,0,24,2,100,20,0xffffffff)
	...
	pTeamButton_YZDEL:AddFont("颇萍备己", 15, 8, 0, 0, 179, 56, 0xffffff)
	...
	pSingleButton_YZDEL:AddFont("教臂概摹", 15, 8, 0, 0, 179, 56, 0xffffff)
	...
	pSingleButton_TTPW:AddFont("教臂概摹", 15, 8, 0, 0, 179, 56, 0xffffff)
	-- pSingleButton_TTPW:AddFont("19:00 - 23:00 俺规", 15, 0, 25, -20, 200, 15, 0xff0000)
	pSingleButton_TTPW:AddFont("辟老傍俺", 15, 8, 0, 20, 179, 15, 0xff0000)
	...
	pSingleButton_ECYSZ:AddFont("教臂概摹", 15, 8, 0, 0, 179, 56, 0xffffff)
	pSingleButton_ECYSZ:AddFont("18:00 - 22:00 俺规", 15, 8, 0, 20, 179, 15, 0xff0000)
...
function GetLogFont()
	LogFont = "["..LogPlayerName_YZDEL.."]家券["..LogMonsterName_YZDEL.."]硼摹己傍, 袍嚼垫["..LogItemName_YZDEL.."]。"
	--log("\n"..LogFont)
end
