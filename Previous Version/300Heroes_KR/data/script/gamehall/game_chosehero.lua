...
local BTN_showAllBK = {}
local BTN_showAllFont = {"傈眉焊扁","鞠混","傈荤","攀农","盔掉","过荤","辑讫"}
local index_showAll = 1
local BTN_oftenUseBK = {}
local BTN_oftenUseFont = {"弥脚康旷","茄沥魄概","惑侩快急","磊林荤侩","弥辟免傈","弥绊铰伏"} 
...
function InitMainGame_ChoseHero(wnd)
	...
	btn_heroSearch:AddFont("康旷八祸",12,0,22,6,100,15,0xbeb5ee)	
	...
	btn_heroBelong:AddFont("康旷沥纺",12,0,22,6,100,15,0xbeb5ee)
