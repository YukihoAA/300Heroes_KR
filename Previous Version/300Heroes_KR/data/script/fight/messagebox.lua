...
function InitMain_MessageBox(wnd)
	...
	message = wnd:AddFont("辑滚傈价坷幅惯积！！！", 15, 0, 40, 60, 330, 150, 0xbeb9cf)
	--message:SetFontSpace(1,0)
	Font_jieshou = btn_jieshou:AddFont("荐遏",15,8,0,0,90,42,0xbeb5ee)
	Font_yes = btn_yes:AddFont("抗",15,8,0,0,90,42,0xbeb5ee)
	Font_skip = btn_skip:AddFont("檬岿",15,8,0,0,90,42,0xbeb5ee)
	Font_confirm = btn_confirm:AddFont("犬牢",15,8,0,0,90,42,0xbeb5ee)
	Font_cancel = btn_cancel:AddFont("秒家",15,8,0,0,90,42,0xbeb5ee)
	Font_no = btn_no:AddFont("NO",15,8,0,0,90,42,0xbeb5ee)
	Font_jujue = btn_jujue:AddFont("芭例",15,8,0,0,90,42,0xbeb5ee)
	Font_continue = btn_continue:AddFont("拌加",15,8,0,0,90,42,0xbeb5ee)
end
