...
function InitMain_Surrender(wnd)
	...
	Yes_Surrender:AddFont("同意",15,0,25,10,100,15,0xbeb5ee)
	...
	No_Surrender:AddFont("拒绝",15,0,25,10,100,15,0xbeb5ee)
	...
	SurrenderBK:AddFont("发起投降",15,0,125,25,100,15,0xbeb5ee)--,"bdzy")
end
