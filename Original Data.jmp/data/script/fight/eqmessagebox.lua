...
function InitMain_EqMessageBox(wnd)
	...
	----文字
	message1 = wnd:AddFont("使用钻石", 15, 0, 30, 50, 340, 60, 0xbeb9cf)
	message2 = wnd:AddFont("使用金币", 15, 0, 30, 100, 340, 60, 0xbeb9cf)
	...
	Font_charge = btn_charge:AddFont("充值",15,0,25,10,100,15,0xbeb5ee)
	AutoBtn:AddFont("自动强化",15,0,10,10,100,15,0xbeb5ee)
