...
function BackToServerSelection()
	ShowServerselection(1)					--log("\nBackToServerSelection    1")
	SetGameHallIsVisible(0)					--log("\nBackToServerSelection    2")
	SetGameFightIsVisible(0)				--log("\nBackToServerSelection    3")
	SetTeamFightIsVisible(0)
	--SetTeamFightVisible(0,1)
	SetGameEquipIsVisible(0)				--log("\nBackToServerSelection    4")
	...
	SetGameHeroIsVisible(0)					--log("\nBackToServerSelection    5")
	SetGameShopIsVisible(0)					--log("\nBackToServerSelection    6")
	...
	SetTaskIsVisible(0,0)						--log("\nBackToServerSelection    7")
	SetPlayerInfoIsVisible(0)				--log("\nBackToServerSelection    8")
	SetTalent_InsideIsVisible(0)			--log("\nBackToServerSelection    81")
		
	--Set_SetupIsVisible(0)					--log("\nBackToServerSelection    9")
	--SetMailIsVisible(0)                     --log("\nBackToServerSelection    10")
	--SetTalkIsVisible(0)                     --log("\nBackToServerSelection    11")
	--SetsigninIsVisible(0)                   --log("\nBackToServerSelection    12")
	Set_SetupIsVisible(0)
	SetMailIsVisible(0)
	SetTalkIsVisible(0)
	SetShopBuyIsVisible(0)                  --log("\nBackToServerSelection    14")
	SetBagBuyUiIsVisible(0)
	                                        
	SetGameStartIsVisible(0)                --log("\nBackToServerSelection    14")
	SetGameChoseHeroIsVisible(0)            --log("\nBackToServerSelection    15")
	--SetReadyTimeIsVisible(0)              --log("\nBackToServerSelection    7")
	SetEquip_InsideIsVisible(0)             --log("\nBackToServerSelection    16")
	SetShop_InsideIsVisible(0)              --log("\nBackToServerSelection    17")
                                            
	-- SetLolmainIsVisible(0)               log("\nBackToServerSelection    7")
	-- SetHerodataIsVisible(0)              log("\nBackToServerSelection    7")
	-- SetFunctionbtnIsVisible(0)           log("\nBackToServerSelection    7")
	-- SetFighttagetIsVisible(0)            log("\nBackToServerSelection    7")
	-- SetFightbagIsVisible(0)              log("\nBackToServerSelection    7")
	-- SetFarshopIsVisible(0)               log("\nBackToServerSelection    7")
	-- SetDeaddataIsVisible(0)              log("\nBackToServerSelection    7")
	-- SetDataIsVisible(0)                  log("\nBackToServerSelection    7")
	-- SetTabIsVisible(0)                   log("\nBackToServerSelection    7")
	-- SetStateIsVisible(0)                 log("\nBackToServerSelection    7")
	-- SetScoreIsVisible(0)                 log("\nBackToServerSelection    7")
	-- SetMinimapIsVisible(0)               log("\nBackToServerSelection    7")
	                                        
	SetFourpartUIVisiable(0)                --log("\nBackToServerSelection    18")
	
	SetGameSkinFrameIsVisible(0)
	ClearAll_skinframe()					 --log("\nBackToServerSelection    over")
...
function BackToGameHall()
	...
	SetGameHallIsVisible(1)					--log("\nBackToGameHall   15")
	
	SetGameSkinFrameIsVisible(0)			--log("\nBackToGameHall   16")
	ClearAll_skinframe()					--log("\nBackToGameHall   over")
