...
function InitMain_BattleSignalSetting(wnd)
	...
	for i=1, 4 do
		...
		TacticsEdit[i]:SetDefaultFontText( "×Ô¶¨ÒåÃüÁî", 0xffffffff)
		...
		TacticsSaveButton:AddFont( "±£´æ", 15, 8, 0, 0, 110, 27, 0xffffff)
		TacticsCloseButton:AddFont( "¹Ø±Õ", 15, 8, 0, 0, 110, 27, 0xffffff)
