...
function InitMain_Mail(wnd)
	...
	local AA = img_MailBg:AddFont("林狼: 皋老篮 7老第 昏力邓聪促 (梅何等 拱前捞 乐阑矫 30老)", 11, 0, 15, 460, 400, 12, 0xb27936)
	AA:SetFontSpace(1,1)
	-- 邮件列表创建
	local iX,iY = 12,135
	for i = 1, 8 do
		...
		MailItemList.Name[i] = MailItemList[i]:AddFont("老惑: 概老 惯价"..i, 12, 8, -107, -10, 125, 20,  0xff87ced4)
	...
	local Fa = btn_TackAll:AddFont("傈何凯扁", 15, 8, 0, 0, 100, 32, 0xffffff)
	...
	local Fb = btn_DelMail:AddFont("傈何昏力", 15, 8, 0, 0, 100, 32, 0xffffff)
	Fb:SetTouchEnabled(0)
	local AM = btn_DelMail:AddFont("梅何拱前捞 乐绰 皋老捞 乐澜",11, 0, -12, 31, 150, 12, 0xb27936)
	AM:SetFontSpace(1,1)
	...
	font_MailInfoName = img_MailInfoBg:AddFont("老惑: 概老 惯价", 15, 0, 69, 70, 300, 20, 0xff87ced4)
	img_MailInfoBg1 = img_MailInfoBg:AddImage(path_setup.."InfoBg_mail.png", 27, 99, 458, 228)
	font_MailInfo = img_MailInfoBg1:AddFont("拌沥捞抚老蚌磊", 15, 0, 10, 10, 440, 200, 0xffffffff)
	font_MailInfoLastDay = img_MailInfoBg1:AddFont("快祈拱父丰老磊：XX老", 11, 0, 330, 205, 120, 11, 0xc23452)
	...
	local Fa = btn_DelMailInfo:AddFont("傈何昏力", 15, 8, 0, 0, 100, 32, 0xffffff)
	Fa:SetTouchEnabled(0)
