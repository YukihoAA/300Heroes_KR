...
function InitStaticserver_selectionUI(wnd)
	...
	ServerPing = wnd:AddFont("烹脚剧龋",15,0,980 - 48,300,200,15,0x00ff00)
	...
	img_DianXinTuiJian:AddFont("烹脚剧龋",15,0,55,-20,500,15,0xff00ff00)
	img_WangTongTuiJian:AddFont("烹脚剧龋",15,0,55,-20,500,15,0xff00ff00)
	...
	img_Id:AddFont("拌沥",18,0,29,6,500,20,0xffffffff)
	...
	img_Pass:AddFont("鞠龋",18,0,29,6,500,20,0xffffffff)
	...
	remember_user:AddFont("拌沥历厘",15,0,40,0,500,20,0xffffffff)
...
function GetServerPing(Ping, index)
	...
	if (Ping >= 0 and Ping < 200) then
		ServerPing:SetFontText("烹脚剧龋",0xff00ff00)
	end
