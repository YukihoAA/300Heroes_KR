...
local Equip_BtnFont = {"傍拜屈","付过屈","规绢屈","捞悼加档","榜靛裙垫","己厘幅","力绢幅","坷坷扼","家葛前"}
local PyAttack_kidFont = {"傍拜仿","摹疙伏","傍拜加档","厘癌包烹","积疙软荐"}
local MgAttack_kidFont = {"林巩碍档","酿沤皑家","付唱雀汗","付唱樊","林巩包烹"}
local Defence_kidFont = {"积疙仿","厘癌樊","林巩历亲","积疙雀汗","碍牢"}
...
function InitMain_MarketC(wnd)	
	-- 文字
	wnd:AddFont("眠玫厘厚",15,0,532,23,100,20,0x7787c3)
	wnd:AddFont("惑困酒捞袍",15,0,528,108,100,20,0x7787c3)
	wnd:AddFont("窍困袍",15,0,540,210,100,20,0x7787c3)
	wnd:AddFont("荤侩磊眠玫",15,0,630,23,100,20,0x83d1e6)
	wnd:AddFont("泅犁\n厘厚",15,0,178,475,100,100,0x7787c3)
	check_talent:AddFont("眠玫厘厚磊悼备涝",15,0,20,-3,200,20,0x83d1e6)
	btn_suggest:AddFont("扁夯眠玫",15, 8, 0, 0, 100, 30, 0xffffff)
	...
	for i=1,Max_MarketGoods do
		market_name[i] = market_equip[i]:AddFont("脚扁公利"..i,15,0,45,5,130,20,0xffffff)
	...
	btn_BuyEquip:AddFont("备概",15,0,22,8,200,100,0xffffff)
	btn_SellEquip:AddFont("魄概",15,0,22,8,200,100,0xffffff)
