...
function InitDataWnd(wnd)
	...
	for i = 1, 3 do
		...
		killer.nameText[i] = killer[i]:AddFont("ƒ≥∏Ø¿Ã∏ß 7±€¿⁄/øµøı 5±€¿⁄",12,0,54,140,160,12,whiteColor)
		for k = 1, 5 do
			killer.damage[i].nameText[k] = killer.damage[i].wnd[k]:AddFont("ø’¿«∫∏∞Ì",12,0,40,1+40*(k-1),200,12,skillNameColor)
			killer.damage[i].detailText[k] = killer.damage[i].wnd[k]:AddFont("605    (40%  π∞∏Æ«««ÿ)",12,0,40,21+40*(k-1),200,12,physicalColor)
		end		
	end
